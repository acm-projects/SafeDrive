  ...
  Widget build(BuildContext context) {
    Future<void> driveInfoUpload() async {
      ...
      FirebaseFirestore.instance
        ...
        'Vehicle License Plate Number': vehicleLicensePlate.text,
        'Vehicle Identification Number': vehicleIdentification.text,
      });
    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all<Color>(contrastAccentOne),
                    ),
                    onPressed: () {
